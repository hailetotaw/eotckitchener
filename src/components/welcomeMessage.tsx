    ...
    <div className="p-8">
      <div className="bg-white bg-opacity-70 p-8 shadow-md rounded-lg">
        ...
        <p className="text-gray-800 mb-4 pt-4">
          ...
          dedicated congregation committed to fostering the spiritual and
        ...
        <p className="text-gray-800 mb-4">
          ...
          it to grow and thrive within its own space. Since then, Debre Sina
        ...
        <p className="text-gray-800 mb-4">
          ...
          youth and children&apos;s spiritual development, offering dedicated
          services and programs to nurture the younger members of the
          congregation. Through the commitment of its members and the grace of
          God, Debre Sina Kidan Mehret Ethiopian Orthodox Church continues to
          serve as a beacon of faith and community for Ethiopians in
          southwestern Ontario under the Holy Synod Archdiocese of Eastern
          Canada.
        </p>
      </div>
    </div>
